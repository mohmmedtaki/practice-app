...
function Home() {
  ...
  function handleClick() {
    navigate("/ImageCategory");
  }
  function Click() {
    navigate("/RandomImage");
  }
  function books() {
    navigate("/BookList");
  }
      ...
      <Carousel>
        <Carousel.Item interval={1000}>
          ...
          <Carousel.Caption>
            ...
            >
              Our image category for products
            </h1>
            <button
              style={{
                marginBottom: "30px",
        ...
        <Carousel.Item interval={500}>
          <img
            style={{ height: "550px" }}
            className="d-block w-100"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKvKtBqsWfu99mZgMRJEZQQDxTueeA-KrJKA&usqp=CAU"
            alt="Second slide"
          />
          <Carousel.Caption>
            <h1
        ...
        <Carousel.Item>
          <img
            style={{ height: "550px" }}
            className="d-block w-100"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA-fQi47OlVAHj05VNTP07DEnUk_wN0akpLA&usqp=CAU"
            alt="Third slide"
          />
          <Carousel.Caption>
            <h1
        ...
        <Carousel.Item interval={500}>
          <img
            style={{ height: "550px" }}
            className="d-block w-100"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVUvkIoho9VXsNTmPsAmG1KJS-toagidhhrg&usqp=CAU"
            alt="Second slide"
          />
          <Carousel.Caption>
            <h1
